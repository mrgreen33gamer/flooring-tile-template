...
const logoName = 'Heritage Flooring & Tile Co.';
const logoTagline = 'Hardwood · Tile · Carpet · LVP';
const navLinks = [
  { href: '/', label: 'Home' },
...
const phoneDisplay = '(254) 715-3900';
const phoneHref = 'tel:+12547153900';
...
const footerLine = 'Licensed Flooring Contractor · Waco, TX';
