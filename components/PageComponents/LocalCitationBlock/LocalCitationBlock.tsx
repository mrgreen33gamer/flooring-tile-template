...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'Heritage Flooring & Tile Co.',
  address       = '3110 Bosque Blvd, Waco, TX 76707',
  phone         = '(254) 715-3900',
  email         = 'hello@heritageflooringtx.com',
  googleMapsUrl = 'https://maps.google.com/?q=3110+Bosque+Blvd+Waco+TX+76707',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with NWFA-certified flooring installers.
          </p>
        </div>
