...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Flooring Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `Heritage Flooring & Tile Co. provides hardwood, tile, LVP, and carpet installation to ${cityName} and all surrounding communities. NWFA-certified installers, flat-rate pricing, 5-Year Workmanship Warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12547153900" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
