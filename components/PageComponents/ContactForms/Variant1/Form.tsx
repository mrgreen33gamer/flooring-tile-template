...
const TRUST_CHIPS = [
  ...
  { icon: faShieldHalved, text: 'NWFA · Licensed' },
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A Heritage Flooring specialistnician will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12547153900"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 715-3900', section: 'ContactForm-V1' })}>
                          Call (254) 715-3900
                        </a>
                      </span>
                    </div>
