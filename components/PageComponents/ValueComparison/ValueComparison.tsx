...
const DEFAULT_ROWS: ComparisonRow[] = [
  ...
  { feature: 'Free in-home measure & samples',         us: true,  others: 'Sometimes' },
  { feature: 'No service contracts required',          us: true,  others: false },
  { feature: 'NWFA-certified installers',              us: true,  others: true },
  { feature: 'Upfront quote before material ordered',  us: true,  others: false },
  { feature: 'Hardwood, tile, LVP & carpet',           us: true,  others: 'Sometimes' },
...
export default function ValueComparison({ rows = DEFAULT_ROWS, title = 'Heritage vs. The Other Guys' }: ValueComparisonProps) {
  return (
