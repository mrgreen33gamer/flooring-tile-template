...
export default function CTABanner({
  headline      = "Ready for Floors You'll Love Walking On?",
  subline   = "Free in-home estimates available. Flat-rate pricing — no hidden fees. Call now or book your measure online.",
      ...
      <div className={styles.inner}>
        ...
        >
          <span className={styles.eyebrow}>
            ...
            Central Texas Flooring Experts Since 2011
          </span>
