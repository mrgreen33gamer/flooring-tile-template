...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Flooring Tips & Insights',
  subtitle    = 'Practical advice for Central Texas homeowners — hardwood vs. LVP, tile for Texas humidity, and when it\'s time to replace your floors.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
