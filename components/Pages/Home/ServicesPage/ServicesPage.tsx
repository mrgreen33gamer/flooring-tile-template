  ...
  return (
    ...
    >
      ...
      <nav aria-label="Services navigation" style={{
        ...
        <Link href="/services">All Services — Heritage Flooring & Tile Co.</Link>
      </nav>

      <span id={styles.backgroundImage}>
        <Image quality={100} fill style={{ objectFit: 'cover' }} sizes="100vw" src='/pages/home/services/background-image.png?v=3' alt="Background Image for Services Page - Heritage Flooring & Tile Co. - Background" />
      </span>
    ...
    >
      ...
      >
        <Image
          ...
          src={imgSrc}
          quality={100}
          alt={`${imgAlt} - Heritage Flooring & Tile Co. - Waco TX`}
        />
      </motion.div>
    </motion.div>
  );
