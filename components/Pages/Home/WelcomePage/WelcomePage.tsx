  ...
  return (
    <div className={styles.thermo} aria-hidden="true">
      ...
      <div className={styles.thermoLabels}>
        ...
        <span className={styles.thermoBot}>Measured</span>
      </div>
    </div>
  );
}

const CHIPS = ['Free Estimates', 'No Hidden Fees', 'NWFA Certified', '15+ Yrs Local', '5-Yr Warranty'];
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.content}>
          <motion.div className={styles.badge}
            ...
            Waco&apos;s Most Trusted Flooring Company — Since 2011
          </motion.div>

          <motion.h1 className={styles.headline}
            initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.1 }}>
            Floors Done.<br />Done Right.<br />
            <span className={styles.accentLine}>Heritage.</span>
          </motion.h1>

          <motion.p className={styles.sub}
            initial={{ opacity: 0, y: 14 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.55, delay: 0.22 }}>
            Free in-home estimates. Flat-rate pricing. 5-Year Workmanship Warranty on every install.
            Serving Waco and Central Texas with licensed, NWFA-certified installers.
          </motion.p>

          <motion.div className={styles.ctaRow}
            initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.34 }}>
            <a href="tel:+12547153900" className={styles.ctaPrimary}>
        ...
        >
          ...
          {/* ── stat card: floors installed — upper left ── */}
          <motion.div className={`${styles.statCard} ${styles.sc1}`}
            ...
            <span className={styles.scLbl}>Floors Installed</span>
          </motion.div>
          ...
          {/* ── stat card: estimates — lower right, walnut ── */}
          <motion.div className={`${styles.statCard} ${styles.sc4} ${styles.scOrange}`}
            ...
            <span className={styles.scLbl}>In-Home Estimates</span>
          </motion.div>
