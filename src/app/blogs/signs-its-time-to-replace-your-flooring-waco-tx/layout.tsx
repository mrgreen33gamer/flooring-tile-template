...
const slug     = 'signs-its-time-to-replace-your-flooring-waco-tx';
...
export const metadata: Metadata = {
  ...
  keywords: ['replace flooring Waco TX', 'when to replace hardwood', 'new floors Waco', 'flooring replacement Central Texas'],
...
const articleSchema = {
  ...
  keywords: 'replace flooring Waco TX, flooring replacement Central Texas',
