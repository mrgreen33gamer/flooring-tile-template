...
const slug     = 'how-to-choose-tile-for-central-texas-humidity';
...
export const metadata: Metadata = {
  ...
  keywords: ['tile for humidity Texas', 'porcelain tile Waco', 'bathroom tile Central Texas', 'choose tile Waco TX'],
...
const articleSchema = {
  ...
  keywords: 'tile humidity Texas, porcelain tile Waco',
  articleSection: 'Tile',
  inLanguage: 'en-US',
};
