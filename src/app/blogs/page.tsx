    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>Heritage Flooring &amp; Tile Co. — Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Central Texas homeowners — hardwood vs. LVP, tile for Texas humidity, and when to replace your floors.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need professional flooring installation in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We&apos;ve been installing and refinishing floors for Waco-area homes and businesses since 2011. Free in-home estimate, no obligations.
            </p>
