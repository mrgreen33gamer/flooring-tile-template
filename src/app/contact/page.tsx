...
// Heritage Flooring & Tile Co. — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Hardwood Installation', 'Tile & Stone', 'Luxury Vinyl Plank',
  'Carpet Installation', 'Commercial Flooring', 'Repair & Restoration',
  'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 715-3900 or fill out the form below. We respond to most requests within one business day and can usually schedule an in-home measure within the week.",
  },
  {
  ...
  },
  {
    ...
    answer: 'No — in-home estimates are always free, with no obligation to book. We measure, show samples, and leave you with a firm written price.',
  },
  {
    question: 'Do you handle commercial flooring projects?',
  ...
  },
  {
    ...
    answer: "Our installer will tell you honestly after the assessment. If repair or refinish will restore the floor, we recommend that first — full replacement only when it makes sense. We'll always show you the numbers and let you decide.",
  },
];
  ...
  return (
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.heroInner}>
          ...
          <motion.h1 className={styles.heroTitle}
            ...
            Let&apos;s Get Your<br />
            <span className={styles.heroAccent}>New Floors</span>
          </motion.h1>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@heritageflooringtx.com',
                  href:      'mailto:hello@heritageflooringtx.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '3110 Bosque Blvd, Waco TX 76707',
                  href:      'https://maps.google.com/?q=3110+Bosque+Blvd+Waco+TX+76707',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why homeowners choose Heritage</p>
              {[
                'Flat-rate pricing — written quote before we start',
                '5-Year Workmanship Warranty on every install',
                'NWFA-certified, licensed installers only',
                'Free in-home measures & samples',
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A Heritage Flooring specialist will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547153900">(254) 715-3900</a>.
                  </p>
                ...
                <motion.div key="form" className={styles.formCard}
                  ...
                  <div className={styles.formCardHeader}>
                    ...
                    <div>
                      <h2 className={styles.formTitle}>Request a Free In-Home Estimate</h2>
      ...
      <CTABanner
        ...
        subline="Call (254) 715-3900 — free in-home estimates, flat-rate pricing, 5-Year Workmanship Warranty."
